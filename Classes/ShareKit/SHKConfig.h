...
#define SHKMyAppName			@"Gawkwall for iPhone"
#define SHKMyAppURL				@"http://www.gawkwall.com"
...
#define SHKFacebookKey				@"2e57e341eac23e9a2558b2f8fb16af5e"
#define SHKFacebookSecret			@"ddfbc05f2dc616f6b14135f39e5b0a2c"
 ...
 */
#define SHKTwitterConsumerKey		@"YSIUUSTe9exkllYKKDXyA"
#define SHKTwitterSecret			@"v4m56NAetykTwNxzfW5ro7IAiq6LeXTqbKH9ph9U8"
#define SHKTwitterCallbackUrl		@"http://www.gawkwall.com/twitter/" // You need to set this if using OAuth, see note above (xAuth users can skip it)
